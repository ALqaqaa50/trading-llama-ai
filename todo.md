...
## 🚨 عاجل: استمرار خطأ Trade permission رغم الإصلاحات
- [x] فحص قراءة المفاتيح من قاعدة البيانات - المفاتيح محفوظة بشكل صحيح
- [x] المستخدم فعّل صلاحية Trade في OKX
- [x] إضافة logging مفصل لمعرفة الخطأ الحقيقي من OKX
- [ ] اختبار التنفيذ وفحص الخطأ في console logs

## 🔧 تعديل: قراءة جميع الحسابات واستخدام الرصيد الإجمالي
- [x] تعديل fetchBalance لقراءة Funding + Spot + Swap + Future + Margin
- [x] حساب الرصيد الإجمالي من جميع الحسابات
- [x] إضافة تحويل تلقائي من Funding إلى Spot عند الحاجة
- [ ] اختبار التنفيذ بعد التعديل

## 🔍 تحليل: النظام يقرأ $0.89 فقط بدلاً من الرصيد الكامل
- [x] فحص server logs لمعرفة ما يقرأه النظام من كل حساب
- [x] التحقق من أن fetchBalance يقرأ جميع الحسابات بشكل صحيح
- [x] معرفة أين باقي الرصيد ($97+ المفقود) - موجود في Trading Account!
- [x] إصلاح ليقرأ من Trading Account (Unified) بالإضافة لجميع الحسابات
- [x] إضافة logging مفصل لتتبع المشكلة
- [ ] اختبار مع المستخدم ومراجعة console logs

## 💰 تخفيض الحد الأدنى للصفقة لترك مساحة للرسوم
- [x] البحث عن MIN_TRADE_AMOUNT في الكود
- [x] تخفيض من $1.00 إلى $0.80
- [x] زيادة نسبة المخاطرة للحسابات الصغيرة (<$5) من 2% إلى 70%
- [ ] اختبار التنفيذ مع الرصيد $1.1155

## 🔍 فحص: لماذا لا يزال الخطأ "insufficient balance" يظهر؟
- [x] طلب console logs من المستخدم لمعرفة الكمية المحسوبة
- [x] التحقق من أن التعديل (70%) يعمل
- [x] فحص الحد الأدنى الفعلي في OKX - المشكلة: الرصيد أقل من اللازم!
- [ ] إضافة دعم عملات أرخص (DOGE, XRP, TRX) للحسابات الصغيرة

## 🔄 إضافة دعم البيع والشراء بناءً على التحليل
- [ ] تعديل AI prompt ليقرر Buy أو Sell بناءً على التحليل
- [ ] إضافة دعم Sell orders في OKX service
- [ ] تعديل executeTrade ليدعم side: 'buy' | 'sell'
- [ ] تحديث الواجهة لعرض نوع الصفقة (شراء/بيع)
- [ ] اختبار البيع والشراء

## 🚨 إصلاح عاجل: حساب الكمية خاطئ!
- [x] فحص حساب amount في routers.ts (السطر ~460)
- [x] المشكلة: النظام يحاول تنفيذ صفقة بأكثر من $1,000,000!
- [x] إصلاح الحساب ليستخدم السعر الحالي من OKX
- [ ] اختبار مع رصيد $96 USDT

## 🔄 تغيير استراتيجية التنفيذ
- [ ] إزالة التنفيذ التلقائي عبر API
- [ ] إضافة روابط مباشرة لـ OKX لتنفيذ الصفقات
- [ ] تحديث AI ليعطي رابط "نفذ في OKX" بدلاً من التنفيذ التلقائي
...
## 🌐 نشر دائم
- [ ] نشر المشروع على Vercel/Railway
- [ ] ربط بـ domain مخصص (اختياري)
- [ ] تفعيل HTTPS

## 📸 تحسين تحليل الصور والمؤشرات الفنية (طلب جديد)
- [ ] تحسين AI prompt لقراءة المؤشرات من الصور (RSI, MACD, Volume, Support/Resistance)
- [ ] إضافة تحليل الشموع اليابانية (Candlestick Patterns)
- [ ] تحديد نوع الصفقة الصحيح (Buy/Sell) من الصورة
- [ ] إعطاء توصيات واضحة مع أسباب مفصلة
- [ ] إضافة رابط مباشر لتنفيذ الصفقة في OKX بعد التحليل
- [ ] اختبار مع صور حقيقية من المستخدم
- [ ] إزالة الكود القديم للتنفيذ التلقائي (cleanup)
